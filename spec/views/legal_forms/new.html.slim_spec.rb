...
RSpec.describe "legal_forms/new", type: :view do
  before(:each) do
    assign(:legal_form, LegalForm.new(
      :event => "MyString",
      :group => "MyString",
      :presenter => "MyString",
      :twitter => "MyString",
  ...
  it "renders new legal_form form" do
    render

    assert_select "form[action=?][method=?]", legal_forms_path, "post" do
